...
class Training(commands.Cog):
    ...
    async def training(self, ctx):
        ...
        try:
            ...
            await ctx.send(
                "<a:success:1034359295548084305> | Training announcement has been posted!")
    ...
    async def endtraining(self, ctx, *, msgID: str):
        ...
        await ctx.send(
            "<a:succces:1034359295548084305> | Training announcement has been edited and the training has ended!")
