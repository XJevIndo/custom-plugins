...
class Training(commands.Cog): 
    ...
    async def training(self, ctx):
        ...
        try:
            ...
            embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/633681171879952384/990312929712799774/phonto.png")
    ...
    async def endtraining(self, ctx, *, msgID: str):
        ...
        embed2.set_thumbnail(url="https://cdn.discordapp.com/attachments/633681171879952384/990312929712799774/phonto.png")
